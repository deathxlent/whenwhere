...
const argentinaProvinces = [
  ...
  {name:'查科',lat:-27.4258,lng:-59.0244},{name:'科连特斯',lat:-27.4806,lng:-58.8341},
  {name:'圣路易斯',lat:-33.2950,lng:-66.3356},{name:'圣地亚哥-德尔埃斯特罗',lat:-27.7951,lng:-64.2615},
  {name:'胡胡伊',lat:-24.1858,lng:-65.2995},{name:'内格罗河',lat:-40.8135,lng:-63.0000},
  {name:'内乌肯',lat:-38.9516,lng:-68.0591},{name:'丘布特',lat:-43.3002,lng:-65.1023},
  {name:'圣克鲁斯',lat:-51.6226,lng:-69.2181},{name:'火地岛',lat:-54.8019,lng:-68.3030},
  {name:'拉里奥哈',lat:-29.4131,lng:-66.8506},{name:'卡塔马卡',lat:-28.4696,lng:-65.7852},
  {name:'福莫萨',lat:-26.1775,lng:-58.1781},{name:'圣胡安',lat:-31.5375,lng:-68.5364},
  {name:'拉潘帕',lat:-36.6167,lng:-64.2833}
];
...
const polandVoivodeships = [
  ...
  {name:'西里西亚',lat:50.2649,lng:19.0238},{name:'大波兰',lat:52.4064,lng:16.9252},
  {name:'下西里西亚',lat:51.1079,lng:17.0385},{name:'罗兹',lat:51.7592,lng:19.4560},
  {name:'库亚维-波美拉尼亚',lat:53.0102,lng:18.5985},{name:'波美拉尼亚',lat:54.3520,lng:18.6466},
  {name:'卢布林',lat:51.2465,lng:22.5684},{name:'波德拉谢',lat:53.1325,lng:23.1688},
  {name:'瓦尔米亚-马祖里',lat:53.7786,lng:20.4801},{name:'西波美拉尼亚',lat:53.4285,lng:14.5528},
  {name:'卢布斯卡',lat:51.9356,lng:15.5062},{name:'奥波莱',lat:50.6751,lng:17.9213},
  {name:'圣十字',lat:50.8661,lng:20.6286},{name:'喀尔巴阡山',lat:50.0412,lng:21.9991}
];
...
const ukraineOblasts = [
  {name:'基辅',lat:50.4501,lng:30.5234},{name:'哈尔科夫',lat:49.9935,lng:36.2304},
  {name:'敖德萨',lat:46.4825,lng:30.7233},{name:'第聂伯罗',lat:48.4647,lng:35.0462},
  {name:'顿涅茨克',lat:48.0017,lng:37.8031},{name:'扎波罗热',lat:47.8388,lng:35.1396},
  {name:'利沃夫',lat:49.8397,lng:24.0297},{name:'克里米亚',lat:45.3195,lng:34.1079},
  {name:'文尼察',lat:49.2331,lng:28.4682},{name:'波尔塔瓦',lat:49.5883,lng:34.5514},
  {name:'切尔尼戈夫',lat:51.4982,lng:31.2893},{name:'苏梅',lat:50.9077,lng:34.7981},
  {name:'日托米尔',lat:50.2547,lng:28.6587},{name:'切尔卡瑟',lat:49.4444,lng:32.0598},
  {name:'基洛沃格勒',lat:48.5079,lng:32.2623},{name:'尼古拉耶夫',lat:46.9759,lng:31.9946},
  {name:'赫尔松',lat:46.6354,lng:32.6169},{name:'卢甘斯克',lat:48.5740,lng:39.3078},
  {name:'伊万诺-弗兰科夫斯克',lat:48.9226,lng:24.7111},{name:'捷尔诺波尔',lat:49.5535,lng:25.5948},
  {name:'赫梅利尼茨基',lat:49.4230,lng:26.9871},{name:'罗夫诺',lat:50.6199,lng:26.2516},
  {name:'沃伦',lat:50.7472,lng:25.3254},{name:'外喀尔巴阡',lat:48.6208,lng:22.2879},
  {name:'切尔诺夫策',lat:48.2915,lng:25.9343}
];
...
const turkeyProvinces = [
  ...
  {name:'伊兹密尔',lat:38.4237,lng:27.1428},{name:'布尔萨',lat:40.1826,lng:29.0665},
  {name:'安塔利亚',lat:36.8969,lng:30.7133},{name:'阿达纳',lat:37.0000,lng:35.3213},
  {name:'科尼亚',lat:37.8746,lng:32.4932},{name:'加济安泰普',lat:37.0660,lng:37.3781},
  {name:'梅尔辛',lat:36.8000,lng:34.6333},{name:'迪亚巴克尔',lat:37.9144,lng:40.2306},
  {name:'特拉布宗',lat:41.0027,lng:39.7168},{name:'开塞利',lat:38.7312,lng:35.4787},
  {name:'埃斯基谢希尔',lat:39.7767,lng:30.5206},{name:'萨姆松',lat:41.2867,lng:36.3300},
  {name:'凡城',lat:38.4924,lng:43.3800},{name:'埃尔祖鲁姆',lat:39.9000,lng:41.2700},
  {name:'马尔丁',lat:37.3167,lng:40.7333},{name:'尚勒乌尔法',lat:37.1594,lng:38.7969},
  {name:'马尼萨',lat:38.6191,lng:27.4289},{name:'代尼兹利',lat:37.7765,lng:29.0864}
];
...
const saudiProvinces = [
  {name:'利雅得',lat:24.7136,lng:46.6753},{name:'麦加',lat:21.3891,lng:39.8579},
  {name:'麦地那',lat:24.4686,lng:39.6142},{name:'东部省',lat:26.3927,lng:49.9777},
  {name:'阿西尔',lat:18.2465,lng:42.5053},{name:'塔布克',lat:28.3835,lng:36.5662},
  {name:'哈伊勒',lat:27.5114,lng:41.6900},{name:'北部边疆',lat:30.9753,lng:41.0379},
  {name:'贾赞',lat:16.8892,lng:42.5511},{name:'纳季兰',lat:17.4917,lng:44.1277},
  {name:'巴哈',lat:20.0129,lng:41.4677},{name:'卡西姆',lat:26.3267,lng:43.9708},
  {name:'焦夫',lat:29.7864,lng:40.2080}
];
...
// 伊朗省
const iranProvinces = [
  {name:'德黑兰',lat:35.6892,lng:51.3890},{name:'伊斯法罕',lat:32.6546,lng:51.6680},
  {name:'法尔斯',lat:29.5918,lng:52.5837},{name:'呼罗珊拉扎维',lat:36.2972,lng:59.6053},
  {name:'东阿塞拜疆',lat:38.0962,lng:46.2738},{name:'胡齐斯坦',lat:31.3183,lng:48.6706},
  {name:'吉兰',lat:37.2809,lng:49.5921},{name:'马赞德兰',lat:36.5633,lng:53.0590},
  {name:'克尔曼',lat:30.2839,lng:57.0834},{name:'西阿塞拜疆',lat:37.5497,lng:45.0733},
  {name:'洛雷斯坦',lat:33.4878,lng:48.3558},{name:'库尔德斯坦',lat:35.3144,lng:46.9969},
  {name:'哈马丹',lat:34.7992,lng:48.5146},{name:'克尔曼沙赫',lat:34.3142,lng:47.0650},
  {name:'亚兹德',lat:31.8974,lng:54.3569},{name:'锡斯坦-俾路支斯坦',lat:29.4963,lng:60.8629},
  {name:'霍尔木兹甘',lat:27.1865,lng:56.2708},{name:'布什尔',lat:28.9234,lng:50.8205},
  {name:'恰哈马哈勒-巴赫蒂亚里',lat:31.9967,lng:50.8449},{name:'科吉卢耶-博韦艾哈迈德',lat:30.6684,lng:50.8693}
];
...
const egyptGovernorates = [
  ...
  {name:'吉萨',lat:30.0131,lng:31.2089},{name:'卢克索',lat:25.6872,lng:32.6396},
  {name:'阿斯旺',lat:24.0889,lng:32.8998},{name:'红海',lat:27.2579,lng:33.8116},
  {name:'西奈',lat:29.3117,lng:33.6176},{name:'达卡利亚',lat:31.1656,lng:31.4083},
  {name:'布海拉',lat:30.8481,lng:30.3436},{name:'明亚',lat:28.0871,lng:30.7618},
  {name:'索哈杰',lat:26.5569,lng:31.6948},{name:'阿斯尤特',lat:27.1810,lng:31.1837},
  {name:'贝尼苏韦夫',lat:29.0661,lng:31.0994},{name:'法尤姆',lat:29.3100,lng:30.8418},
  {name:'塞得港',lat:31.2653,lng:32.3019},{name:'伊斯梅利亚',lat:30.5833,lng:32.2667},
  {name:'苏伊士',lat:29.9668,lng:32.5498},{name:'盖卢比尤',lat:30.3000,lng:31.2000},
  {name:'谢赫村',lat:31.2656,lng:31.0994},{name:'西部省',lat:30.8754,lng:31.0123},
  {name:'杜姆亚特',lat:31.8133,lng:31.7183},{name:'北西奈',lat:30.2833,lng:33.6176},
  {name:'南西奈',lat:28.5000,lng:33.9000},{name:'新河谷',lat:25.0000,lng:30.5000},
  {name:'马特鲁',lat:31.3539,lng:27.2373},{name:'基纳',lat:26.1551,lng:32.7156}
];
...
const nigeriaStates = [
  ...
  {name:'阿布贾',lat:9.0765,lng:7.3986},{name:'河流',lat:4.7719,lng:6.9833},
  ...
  {name:'巴耶尔萨',lat:4.7500,lng:5.7500},{name:'克罗斯河',lat:5.7500,lng:8.5000},
  {name:'埃邦伊',lat:6.2500,lng:7.7500},{name:'纳萨拉瓦',lat:8.5000,lng:8.5000},
  {name:'阿夸伊博姆',lat:4.9167,lng:7.9667},{name:'夸拉',lat:8.5000,lng:4.5000},
  {name:'纳萨拉瓦',lat:8.5333,lng:8.5000},{name:'吉加瓦',lat:12.2000,lng:9.5000}
];

nigeriaStates.forEach(p => {
  newFeatures.push({
    type: 'Feature',
    properties: { name: p.name, country: '尼日利亚', admin_level: '